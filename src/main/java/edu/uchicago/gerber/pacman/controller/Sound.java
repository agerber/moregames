package edu.uchicago.gerber.pacman.controller;
...
public class Sound {
	...
	public static Clip clipForLoopFactory(String strPath){
		...
		try {
			AudioInputStream aisStream =
					AudioSystem.getAudioInputStream(edu.uchicago.gerber.sinistar.mvc.controller.Sound.class.getResourceAsStream("/pacman/sounds/" + strPath));
