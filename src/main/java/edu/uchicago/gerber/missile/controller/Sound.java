package edu.uchicago.gerber.missile.controller;
			...
			public void run() {
				try {
					...
					AudioInputStream aisStream =
							AudioSystem.getAudioInputStream(edu.uchicago.gerber.sinistar.mvc.controller.Sound.class.getResourceAsStream("/missile/sounds/" +strPath));
